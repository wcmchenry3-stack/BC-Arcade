...
export const localeLoaders: Record<string, Loaders> = {
  en: {
    ...
    stats: () => import("./locales/en/stats.json") as TranslationModule,
  },
  "fr-CA": {
    ...
    profile: () => import("./locales/fr-CA/profile.json") as TranslationModule,
    starswarm: () => import("./locales/fr-CA/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/fr-CA/mahjong.json") as TranslationModule,
    sort: () => import("./locales/fr-CA/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/fr-CA/stats.json") as TranslationModule,
  },
  es: {
    ...
    profile: () => import("./locales/es/profile.json") as TranslationModule,
    starswarm: () => import("./locales/es/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/es/mahjong.json") as TranslationModule,
    sort: () => import("./locales/es/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/es/stats.json") as TranslationModule,
  },
  hi: {
    ...
    profile: () => import("./locales/hi/profile.json") as TranslationModule,
    starswarm: () => import("./locales/hi/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/hi/mahjong.json") as TranslationModule,
    sort: () => import("./locales/hi/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/hi/stats.json") as TranslationModule,
  },
  ar: {
    ...
    profile: () => import("./locales/ar/profile.json") as TranslationModule,
    starswarm: () => import("./locales/ar/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/ar/mahjong.json") as TranslationModule,
    sort: () => import("./locales/ar/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/ar/stats.json") as TranslationModule,
  },
  zh: {
    ...
    profile: () => import("./locales/zh/profile.json") as TranslationModule,
    starswarm: () => import("./locales/zh/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/zh/mahjong.json") as TranslationModule,
    sort: () => import("./locales/zh/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/zh/stats.json") as TranslationModule,
  },
  ja: {
    ...
    profile: () => import("./locales/ja/profile.json") as TranslationModule,
    starswarm: () => import("./locales/ja/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/ja/mahjong.json") as TranslationModule,
    sort: () => import("./locales/ja/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/ja/stats.json") as TranslationModule,
  },
  ko: {
    ...
    profile: () => import("./locales/ko/profile.json") as TranslationModule,
    starswarm: () => import("./locales/ko/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/ko/mahjong.json") as TranslationModule,
    sort: () => import("./locales/ko/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/ko/stats.json") as TranslationModule,
  },
  pt: {
    ...
    profile: () => import("./locales/pt/profile.json") as TranslationModule,
    starswarm: () => import("./locales/pt/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/pt/mahjong.json") as TranslationModule,
    sort: () => import("./locales/pt/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/pt/stats.json") as TranslationModule,
  },
  he: {
    ...
    profile: () => import("./locales/he/profile.json") as TranslationModule,
    starswarm: () => import("./locales/he/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/he/mahjong.json") as TranslationModule,
    sort: () => import("./locales/he/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/he/stats.json") as TranslationModule,
  },
  de: {
    ...
    profile: () => import("./locales/de/profile.json") as TranslationModule,
    starswarm: () => import("./locales/de/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/de/mahjong.json") as TranslationModule,
    sort: () => import("./locales/de/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/de/stats.json") as TranslationModule,
  },
  nl: {
    ...
    profile: () => import("./locales/nl/profile.json") as TranslationModule,
    starswarm: () => import("./locales/nl/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/nl/mahjong.json") as TranslationModule,
    sort: () => import("./locales/nl/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/nl/stats.json") as TranslationModule,
  },
  ru: {
    ...
    profile: () => import("./locales/ru/profile.json") as TranslationModule,
    starswarm: () => import("./locales/ru/starswarm.json") as TranslationModule,
    mahjong: () => import("./locales/ru/mahjong.json") as TranslationModule,
    sort: () => import("./locales/ru/sort.json") as TranslationModule,
    ...
    stats: () => import("./locales/ru/stats.json") as TranslationModule,
  },
};

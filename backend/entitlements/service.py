...
# Keep in sync with is_premium=True rows (migrations 0014, 0016, 0020, 0022) — update
# when adding a premium game.
_ALL_PREMIUM_SLUGS = ["blackjack", "cascade", "hearts", "mahjong", "starswarm", "sudoku"]
